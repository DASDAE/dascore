"""
Tests for the spool side of the inventory workflow.

Attaching and removing an inventory, lazy reads and equality, enriching
on extraction, selecting and unselecting on inventory-stated facts and
fiber coordinates, conforming, and expanding by a coordinate's values.
Patch-level enrichment itself is tested in
...
class TestSpoolUnion:
    """An inventory and its enrichment survive combining spools."""
...
class TestSelectorEdgeShapes:
    """Edge selector shapes and rows mean what the index side means."""
...
class TestSharedNames:
    """Names shared between namespaces keep their meanings."""
