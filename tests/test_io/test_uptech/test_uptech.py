...
class TestRead:
    ...
    def test_read(self, uptech_path):
        ...
        assert patch.attrs.fiber_length_units == dc.get_quantity("m")
...
class TestScan:
    ...
    def test_scan(self, uptech_path):
        ...
        attrs = UptechH5V1().scan(uptech_path)[0]
        assert attrs.file_format == "Uptech_H5"
        assert attrs.file_version == "1"
        assert attrs.path == str(uptech_path)
    ...
    def test_scan_matches_read(self, uptech_path):
        ...
        assert scanned.coords == patch.attrs.coords
