...
class TestAlignBenchmarks:
    ...
    @pytest.fixture(scope="module")
    def patch_2d_with_1d_shift(self):
        ...
        shift_relative = shift_time_absolute - shift_time_absolute.min()
        return patch.update_coords(
            shift_time=("distance", shift_relative),
        )
    ...
    def test_align_1d_shift_full(self, patch_2d_with_1d_shift):
        ...
        patch.align_to_coord(time="shift_time", mode="full")
