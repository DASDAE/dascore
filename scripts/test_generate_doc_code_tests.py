...
class TestOutputPaths:
    ...
    def test_root_doc_maps_to_root_test(self):
        ...
        # dascore/docs/index.qmd becomes tests/test_autogenerated_doccode/test_index.py
...
class TestRenderAndWrite:
    ...
    def test_render_includes_source_and_chunk_payload(self):
        ...
        source = REPO_ROOT / "dascore" / "docs" / "tutorial" / "example.qmd"
        module = render_test_module(source, (Chunk(start_line=12, source="x = 1\n"),))
        assert "Autogenerated from dascore/docs/tutorial/example.qmd" in module
        assert "@pytest.mark.docs_examples" in module
        assert "def test_main()" in module
        assert "source_qmd = 'dascore/docs/tutorial/example.qmd'" in module
        assert "with qmd_test_context(source_qmd):" in module
        assert "### dascore/docs/tutorial/example.qmd:12" in module
