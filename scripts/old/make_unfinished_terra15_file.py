"""
Make a terra15 file with all zeroes towards the end.

This happens when acquisition stops before the end of pre-allocated file.
"""
...
if __name__ == "__main__":
    ...
    path = here / "tests" / "terra15_large.hdf5"

    start_zeros = -200

    assert path.exists(), f"{path} does not exist!"

    new_path = path.parent / "terra15_das_unfinished.hdf5"
    ...
    with h5py.File(path) as old, h5py.File(new_path, "w") as new:
        ...
        for dataset_name in velgroup:
            ...
            # xero data, and times starting at start_zeroes
            new_data[start_zeros:] = 0
