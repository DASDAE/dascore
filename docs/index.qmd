...
:::{.callout-note}
DASCore is a foundational package of the [DAS Data Analysis Ecosystem (DASDAE)](https://github.com/DASDAE),
and facilitates rapid development of other DASDAE packages that do more specialized analysis or visualization.
:::
