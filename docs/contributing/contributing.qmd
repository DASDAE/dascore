...
To start, follow the [recipes](https://dascore.org/recipes/overview.html) for the contribution and clone DASCore and [install it in development mode](dev_install.qmd).
