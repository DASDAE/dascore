...
Some operations use a [`PatchProcessor`](`dascore.core.processor.PatchProcessor`) with separate metadata and array kernels. A backend package can register its own kernel without changing the operation:
