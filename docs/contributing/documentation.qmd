...
Run them in that order. `index` is what classifies each page by the output it produces, and `site` checks the rendered pages against that classification; skipping it leaves every page that printed something looking like a surprise.
