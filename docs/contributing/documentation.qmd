...
[doctest](https://docs.python.org/3/library/doctest.html) syntax as above, or [quarto code blocks](https://quarto org/docs/output-formats/html-code.html) can be used directly. The latter gives more control over outputs and display options.
