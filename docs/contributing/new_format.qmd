...
[`FiberIO.read_array`](`dascore.io.core.FiberIO.read_array`) returns raw data for absolute sample windows. Its default calls `read()` and trims; override it only when the format can slice storage directly.
