...
Up/down (or left/right) separation is also possible using the `directional` keyword. Up-going (waves moving toward the interrogator, i.e., decreasing distance coordinate) have positive velocities and down-going (waves moving away from the interrogator) have negative velocities. 
