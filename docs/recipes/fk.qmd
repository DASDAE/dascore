...
Another application of [`slope_filter`](`dascore.Patch.slope_filter`) is to separate P/S waves. In this case, the P velocity is about 4500 and the S velocity is about 2700. The following code highlights S waves, but also introduces some artifacts: 
