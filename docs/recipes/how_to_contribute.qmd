...
Navigate to your project's GitHub repository, for instance, https://github.com/<your_username>/dascore, and click "Contribute" and then "Open a pull request" when prompted that your branch is one commit ahead of `DASDAE:main`. GitHub will display the differences between your fork and the original repository. After reviewing, click "Create pull request" and provide a detailed title and description for your changes, explaining the rationale behind your pull request.
