...
If you'd like to contribute to DASCore as a user, you should first fork the DASCore repository.Forking a repository allows you to freely experiment with changes without affecting the original project. Below is a detailed guide on how to do this.
...
Then, create a new branch and follow steps 1 to 3 of the DASDAE developers section above.
