...
| `patch_coords` | coordinate attached to a patch | Links patches to coordinate definitions while retaining the coordinate name and dimensions; `run_index` orders a coordinate's definitions and is 0 today |
