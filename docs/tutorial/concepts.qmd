...
:::{.callout-note}
DASCore uses the superb unit library [pint](https://github.com/hgrecco/pint) under the hood for unit parsing/conversions. You can checkout its documentation for more on how units and quantities work, although DASCore should handle most of this for you.
:::
