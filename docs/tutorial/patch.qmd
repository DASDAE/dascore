...
DASCore implements Patch universal functions, similar to [numpy ufuncs](https://numpy.org/doc/stable/reference/ufuncs.html). You can use numpy ufuncs directly on patches or create patch-specific ufuncs with dimension support.
