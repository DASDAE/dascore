...
class _HDF5IndexManager:
    """
    An object for managing the hdf5 index of DAS files.

    In most cases, this shouldn't be used directly but interacted with through
    the FileSpool.
    """
...
class FileSpool(DataFrameSpool):
    ...
    _index_cache: Optional[_HDF5IndexManager] = None
    # string column sizes in hdf5 table
    _min_itemsize = {
        "path": 79,
        "format": 15,
