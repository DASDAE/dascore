...
- [Coordinate Internals](coordinate_internals.qmd) explains coordinate families, the run table behind every numeric coordinate, summary envelopes, and exact scan payloads.
...
- [Patch Compatibility](patch_compatibility.qmd)
