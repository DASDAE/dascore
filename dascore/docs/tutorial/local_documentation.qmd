...
For an exact API or module identifier, use `doc`, such as `dascore doc module:dascore.viz.waterfall`. Search treats colons and parentheses as query syntax; it does not evaluate Python expressions such as `Patch.select(time=1)`.
