...
Hashing a whole array costs about a second per gigabyte, so pinning is a checkpoint rather than something every operation does. See [Weak and strong `data_id`](../notes/identity.qmd#weak-and-strong-data_id) for what it hashes.
